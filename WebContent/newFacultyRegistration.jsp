...
<body>
<form action="newFacultyInsertion.jsp" method="post">
     <% 
...
<div class="wrapper col2">
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="#">New Faculty Registration</a>
      </li>
...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>Login</li>
      <li>&#187;</li>      
      <li class="current"><a href="#">New Faculty Registration Form</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col4">
  <div id="container">
    <h1>New Faculty Registration Details</h1><br></br>
    <p><u><b>BASIC FORM</b></u></p>
<table>
          <tr>
    <td><b>Faculty Id</b></td><td>    : <input type="text" name="faculty_id" required="required"></td><td><br><br></td>
         </tr>        
         <tr> 
    <td><b> Name</b></td><td>         :<input type="text" name="faculty_name" required="required"></td><td><br><br></td>
       </tr>
       <tr>  
