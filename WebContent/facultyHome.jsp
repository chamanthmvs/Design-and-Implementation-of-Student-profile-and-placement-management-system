...
<body>
<form action="displayAllStudentDataAccordingToBatch.jsp" method="post">
  ...
  <div id="topnav">
    <ul>
      <li><a href="HomePage.jsp">Home</a>
        ...
        <li class="active"><a href="#">Faculty Home</a></li>
     
       <li><a href="facultySearchesStudentByRegistrationNumber.jsp">Search by Registration number</a>
      </li>
...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>Login</li>
      <li>&#187;</li>      
      <li class="current"><a href="#">Faculty Home</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col4">
  <div id="container">
      ...
      pst=con.prepareStatement("select facultydetails.*,departments.departmentName from facultydetails INNER JOIN departments ON facultydetails.departmentId=departments.departmentId where username=? and facultydetails.departmentId=?");
      pst.setString(1,userName);
      PreparedStatement pstmt=con.prepareStatement("select * from batches");
      ResultSet rs1=pstmt.executeQuery();
      pst.setString(2,facultyDeptId);
      ResultSet rs=pst.executeQuery();
     while(rs.next()){ %>
      <h2>Hi &nbsp;<b><%= rs.getString(2)%></b>&nbsp;sir welcome to your page</h2> 
      <h2>Department:&nbsp;&nbsp;&nbsp;<b><%=rs.getString(6)%></b></h2>
      <%} %>
      <p>Select the batch from dropdown you wanted to view entire batch details or select SEARCH BY REGISTRATION NUMBER in tool bar</p>
      <h1></h1><br>
        <h1>
           
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Select Batch</b>    : <select name ="batch" ><% while(rs1.next()){ %><option value="<%= rs1.getString(1)%>"><%= rs1.getString(2) %></option><%} %></select>     <!-- * this is used to indicate that it is mandatory -->
