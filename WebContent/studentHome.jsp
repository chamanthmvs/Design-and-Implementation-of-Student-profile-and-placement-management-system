...
String department=(String)session.getAttribute("dept");
 PreparedStatement pst=con.prepareStatement("select studentdetails.student_FirstName,studentdetails.student_id,departments.departmentName,courses.courseName from  studentdetails INNER JOIN departments ON studentdetails.departmentId=departments.departmentId INNER JOIN courses ON studentdetails.courseId=courses.courseId where username=?");
...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>Login</li>
      <li>&#187;</li>      
      <li class="current"><a href="#">Student Home</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper col4">
  ...
  <%while(rs.next()){ %>	
    ...
    <%} %>
    <h1>Student Access Functions</h1><br></br>
    <p>These following functions are accessed by faculty</p><br></br>
    <ul>
