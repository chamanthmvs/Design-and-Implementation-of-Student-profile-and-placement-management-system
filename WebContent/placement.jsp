...
<body>
<form action="displayAllStudentDataAccordingToCGPAandBatches.jsp" method="post">
...
<div class="wrapper col2">
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="#">TPO cell</a></li>
...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>Login</li>
      <li>&#187;</li>      
      <li class="current"><a href="#">TPO</a></li>
    </ul>
  </div>
</div>
<!-- ####################################################################################################### -->
  ...
  <div id="container">
     ...
     PreparedStatement pstmt=con.prepareStatement("select * from batches");
      ResultSet rs1=pstmt.executeQuery();%>
       ...
       <h2>This is <b>Training & Placement Office cell Of AUCE</b></h2> 
      
    
       <p>Select the batch and CGPA from dropdown you wanted to view entire batch details or select SEARCH BY REGISTRATION NUMBER in tool bar</p>
      <h1></h1><br>
        <h1>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Select CGPA</b>    : <select name ="cgpa" >
  <option value="6.0">6.0</option>
  <option value="6.5">6.5</option>
  <option value="7.0">7.0</option>
  <option value="7.5">7.5</option>
</select>     <!-- * this is used to indicate that it is mandatory -->
    ...
    <h1>Placement Admin Access Functions</h1>
    <p>These following functions are accessed by Placement Admin</p>
    <ul>
      <li>You can view all students by selecting CGPA and Batch<br></br></li>
      </ul>
